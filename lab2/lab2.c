...
int main() { 
	...
	// Set control register bits for 'mode 14' - Fast PWM with ICR1 to define the TOP
	...
	// set the data direction register for PortD Pin5 where we are putting our green LED
	DDRD |= 1 << DDD5;
